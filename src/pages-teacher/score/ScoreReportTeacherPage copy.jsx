          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3 mb-1">
                ...
                Academic Results Manager
              </h1>
              <p className="text-gray-500">Calculate and publish student grades for semester or monthly periods.</p>
            </div>
            
            {getClassInfo() && (
              <div className="flex items-center gap-3 px-5 py-3 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl border border-indigo-200 shadow-sm">
                <div className="p-2 bg-white rounded-lg shadow-sm">
                  <Users className="text-indigo-600" size={20} />
                </div>
                <div>
                  <p className="text-xs text-indigo-600 font-bold uppercase tracking-wide">Active Class</p>
                  <p className="text-sm font-bold text-gray-900">{getClassInfo().name}</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select 
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all hover:border-gray-300"
              >
              ...
              {Object.keys(calculatedResults).length > 0 && selectedSubject !== 'all' && (
                <>
                  ...
                  <button 
                    ...
                    disabled={publishing}
                    className="flex-1 h-[42px] bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-xl font-bold hover:from-emerald-700 hover:to-emerald-800 transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {publishing ? (
                      <>
